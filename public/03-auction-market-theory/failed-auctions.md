---
description: Recognize when an attempted price discovery cannot attract continued trade and returns to the prior auction.
...
2. Price trades beyond it, often triggering stops and breakout entries.
3. The new area fails to develop time or volume.
